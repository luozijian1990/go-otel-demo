...
func (c Config) Validate() error {
	...
	if c.Server.Name == "service-b" {
		if c.Peer.ServiceCURL == "" {
			return fmt.Errorf("peer.service_c_url is required for service-b")
		}
		if c.Peer.ServiceDURL == "" {
			return fmt.Errorf("peer.service_d_url is required for service-b")
		}
	}
